...
class CONFIG {
      ...
      public static $account = 'VPAPI';
      public static $password = 'VPAPI';
      public static $apicode = '3000592';
	  ...
	  public static $querys = array(
		  ...
		  'haina' => 'https://api.100credit.cn/HainaApi/data/getData.action',
              'insure' => 'https://api.100credit.cn/insureApi/data.do', //保险
              'loan' => 'https://api.100credit.cn/loanwarn/v1/upload_data',//贷中
              'dcp' => 'https://api.100credit.cn/cobweb/v1/get_data' //贷后
	  );
