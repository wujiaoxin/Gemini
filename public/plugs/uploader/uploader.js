function sentUploader(options){
    ...
    $(function() {
        ...
        var createOptions = $.extend({}, updefaults, options);
        uploader = WebUploader.create(createOptions);
        ...
        function addFile( file ) {
            var $li = $( '<li id="' + file.id + '">' +
                ...
                $btns = $('<div class="file-panel">' +
                    ...
                    '<span class="rotateRight">向右旋转</span>').appendTo( $li ),
        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'uploading':
                    $( options.wrap +'FilePicker2' ).addClass( 'element-invisible' );
                    $progress.show();
                    $upload.text( '暂停上传' );
                    break;
